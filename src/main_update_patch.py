...
async def lifespan(app: FastAPI) -> AsyncIterator[None]:
    ...
    try:
        ...
        logger.info("LifecycleManager initialised (phase: %s).", app.state.lifecycle_manager.phase)
    except Exception as exc:
    ...
    heartbeat_task = asyncio.create_task(
        automaton.heartbeat(), name="hydra-automaton-heartbeat"
    )
    automaton._running = True
